...
public class CustomerDBRepository extends DataBaseRepository<Customer> {
    ...
    private void createTable() {
        String createSQL = "CREATE TABLE IF NOT EXISTS Customer (id INT, firstName VARCHAR(100), lastName VARCHAR(100), email VARCHAR(100), underage INT, membershipId INT, PRIMARY KEY(id), FOREIGN KEY (membershipId) REFERENCES Membership(id));";
        try {
    ...
    public void add(Customer obj) {
        String addSQL = "INSERT INTO TABLE Customer (id, firstName, lastName, email, underage, membershipId) VALUES (" + obj.getId() + ", " + obj.getFirstName() + ", " + obj.getLastName() + ", " + obj.getEmail() + ", " + obj.getMembershipId() + ");";
        try {
