...
class Main {
    public static void main(String[] args) {
        IRepository<Customer> customerRepo = new CustomerDBRepository();
        ...
        IRepository<Staff> staffRepo = new StaffDBRepository();
        ...
        IRepository<Booking> bookingRepo = new BookingDBRepository();
        ...
        IRepository<Showtime> showtimeRepo = new ShowtimeDBRepository();
        ...
        IRepository<Movie> movieRepo = new MovieDBRepository();
        ...
        IRepository<Screen> screenRepo = new ScreenDBRepository();
        ...
        IRepository<Seat> seatRepo = new SeatDBRepository();
        ...
        IRepository<Ticket> ticketRepo = new TicketDBRepository();
        ...
        IRepository<BasicMembership> basicMembershipRepo = new BasicMembershipDBRepository();
        ...
        IRepository<PremiumMembership> premiumMembershipRepo = new PremiumMembershipDBRepository();
